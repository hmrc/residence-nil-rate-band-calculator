...
class GetNilRateAmountTest extends CommonPlaySpec with WithCommonFakeApplication with MockitoSugar {
  ...
  "Residence Nil Rate Band" must {
    ...
    "return 0 when given a date before the start date of the first RNRB band" in {
      GetNilRateAmount(LocalDate.of(2000, 1, 1), rateBandsAsJson) shouldBe Success(0)
    }

    "return 100000 when given a date of 6 Apr 2017" in {
      GetNilRateAmount(LocalDate.of(2017, 4, 6), rateBandsAsJson) shouldBe Success(100000)
    }

    "return 100000 when given a date of 5 Apr 2018" in {
      GetNilRateAmount(LocalDate.of(2018, 4, 5), rateBandsAsJson) shouldBe Success(100000)
    }

    "return 125000 when given a date of 6 Apr 2018" in {
      GetNilRateAmount(LocalDate.of(2018, 4, 6), rateBandsAsJson) shouldBe Success(125000)
    }

    "return 125000 when given a date of 5 Apr 2019" in {
      GetNilRateAmount(LocalDate.of(2019, 4, 5), rateBandsAsJson) shouldBe Success(125000)
    }

    "return 150000 when given a date of 6 Apr 2019" in {
      GetNilRateAmount(LocalDate.of(2019, 4, 6), rateBandsAsJson) shouldBe Success(150000)
    }

    "return 150000 when given a date of 5 Apr 2020" in {
      GetNilRateAmount(LocalDate.of(2020, 4, 5), rateBandsAsJson) shouldBe Success(150000)
    }

    "return 175000 when given a date of 6 Apr 2020" in {
      GetNilRateAmount(LocalDate.of(2020, 4, 6), rateBandsAsJson) shouldBe Success(175000)
    }

    "return 175000 when given a date of 5 Apr 2021" in {
      GetNilRateAmount(LocalDate.of(2021, 4, 5), rateBandsAsJson) shouldBe Success(175000)
    }

    "return 175000 when given a date of 1 Jan 2040" in {
      GetNilRateAmount(LocalDate.of(2040, 1, 1), rateBandsAsJson) shouldBe Success(175000)
    }
