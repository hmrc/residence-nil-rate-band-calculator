# Contributing Guidelines for residence-nil-rate-band-calculator

Hi!  Thanks for taking the time to contribute to the [HMRC Multichannel Digital Tax Platform](https://hmrc.github.io) (MDTP)

We welcome contributions to residence-nil-rate-band-calculator.  By following these guidelines you will greatly improve the likelihood of your change being accepted and merged.
...
Once you've identified (or created) an [issue](https://github.com/hmrc/residence-nil-rate-band-calculator/issues) to work on, please follow these guidelines to contribute code:
