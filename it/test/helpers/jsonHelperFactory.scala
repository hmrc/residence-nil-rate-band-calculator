...
case class jsonHelperFactory() {
  ...
  def jsonRequestFactoryWithExemption(
      dateOfDeath: LocalDate,
      chargeableEstateValue: Double,
      valueOfEstate: Double,
      propertyValue: Double,
  ...
  def jsonRequestFactoryWithExemptionAndDownsizing(
      dateOfDeath: LocalDate,
      chargeableEstateValue: Double,
      valueOfEstate: Double,
      propertyValue: Double,
  ...
  def jsonRequestFactoryWithDownsizing(
      dateOfDeath: LocalDate,
      chargeableEstateValue: Double,
      valueOfEstate: Double,
      propertyValue: Double,
  ...
  def jsonResponseFactory(
      residenceNilRateAmount: Double,
